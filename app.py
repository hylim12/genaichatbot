...
def load_config():
    ...
    config = {
        ...
        'S3_REGION': os.getenv('AWS_REGION', 'ap-southeast-5'),  # Malaysia region
        'QUERY_LAMBDA_ARN': os.getenv('QUERY_LAMBDA_ARN', 'arn:aws:lambda:ap-southeast-5:904331954830:function:cacheme-query'),
